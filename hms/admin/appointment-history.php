...
$sql=mysqli_query($con,"SELECT appointment.userId,appointment.doctorId,appointment.doctorSpecialization,appointment.appointmentDate,appointment.appointmentTime,appointment.doctorStatus FROM tblpatient INNER JOIN appointment ON appointment.userId=tblpatient.PatientReg");
$cnt=1;
